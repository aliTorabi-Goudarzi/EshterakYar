    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Row(
                ...
                val statusText =
                        if (subscription.isActive) stringResource(R.string.active)
                ...
                AssistChip(
                        ...
                        leadingIcon = {
                            Icon(
                                    imageVector =
                                            if (subscription.isActive) Icons.Default.CheckCircle
            ...
            DetailRow(
                    ...
                    "${subscription.price.toInt()} ${subscription.currency}"
            )
            DetailRow(
                    stringResource(R.string.billing_cycle_label) + ":",
                    subscription.billingCycle.persianName
            )
            DetailRow(
                    stringResource(R.string.next_renewal_date_label) + ":",
...
private fun formatDate(date: java.util.Date): String {
    ...
    return "${jalaliDate.day} ${jalaliDate.monthName()} ${jalaliDate.year}" // Month name is full
    // name here
}
