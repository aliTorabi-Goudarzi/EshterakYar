...
class SubscriptionRepositoryImpl(private val subscriptionDao: SubscriptionDao) :
    ...
    override suspend fun getActiveSubscriptionsList(): List<Subscription> {
        return subscriptionDao.getActiveSubscriptions().first()
    }
    ...
    override fun getSubscriptionsByRenewalDateRange(
            startDate: Long,
            endDate: Long
